...
#define FRAM_LED_ON_TIME_ADDR                    (FRAM_TEMP_SETTING_ADDR + FRAM_TEMP_SETTING_DATA_LEN)
...
#define FRAM_LED_ON_LEVEL_ADDR                   (FRAM_LED_ON_TIME_ADDR + FRAM_LED_ON_TIME_DATA_LEN)
...
#define FRAM_ADC_SAMPLE_CNT_ADDR                 (FRAM_LED_ON_LEVEL_ADDR + FRAM_LED_ON_LEVEL_DATA_LEN)
...
#define FRAM_ADC_DELAY_MS_ADDR                   (FRAM_ADC_SAMPLE_CNT_ADDR + FRAM_ADC_SAMPLE_CNT_DATA_LEN)
...
#define FRAM_STABLE_TEMPERATURE_ADDR             (FRAM_ADC_DELAY_MS_ADDR + FRAM_ADC_DELAY_MS_DATA_LEN)
...
#define FRAM_TEMP_RESULT_ADDR                    (FRAM_STABLE_TEMPERATURE_ADDR + FRAM_STABLE_TEMPERATURE_DATA_LEN)
...
#define FRAM_RECV_PD_RESULT_ADDR                 (FRAM_TEMP_RESULT_ADDR + FRAM_TEMP_RESULT_DATA_LEN)
...
#define FRAM_MONITOR_PD_RESULT_ADDR              (FRAM_RECV_PD_RESULT_ADDR + FRAM_RECV_PD_RESULT_DATA_LEN)
...
#define FRAM_DEV_CTRL_LED_STATUS_ADDR            (FRAM_MONITOR_PD_RESULT_ADDR + FRAM_MONITOR_PD_RESULT_DATA_LEN)
