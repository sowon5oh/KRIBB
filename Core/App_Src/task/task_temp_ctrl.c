...
typedef struct {
    ...
    MeasSetTempCtrlType_t temp_ctrl_mode[CH_NUM];
...
static void _set_temp_ctrl_mode(MeasCh_t ch, MeasSetTempCtrlType_t temp_ctrl_mode);
...
static tempCtrlTaskContext_t temp_ctrl_task_context = {
    ...
    .temp_ctrl_mode[CH1_IDX] = TEMP_CTRL_FORCE_OFF,
    .temp_ctrl_mode[CH2_IDX] = TEMP_CTRL_FORCE_OFF,
    .temp_ctrl_mode[CH3_IDX] = TEMP_CTRL_FORCE_OFF, };
