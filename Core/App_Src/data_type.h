...
#define FRAM_TEMPERATURE_OFFSET_ADDR             (FRAM_STABLE_TEMPERATURE_ADDR + FRAM_STABLE_TEMPERATURE_DATA_LEN)
#define FRAM_TEMPERATURE_OFFSET_DATA_LEN         FRAM_TEMPERATURE_OFFSET_SINGLE_DATA_LEN

#define FRAM_TEMP_RESULT_SINGLE_DATA_LEN         MMI_CMD3_MEAS_REQ_ADC_MIN_DATA_LEN
#define FRAM_TEMP_RESULT_ADDR_CH1                (FRAM_TEMPERATURE_OFFSET_ADDR + FRAM_TEMPERATURE_OFFSET_DATA_LEN)
