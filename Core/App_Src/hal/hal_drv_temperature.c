...
void Hal_Temp_AdcCb(void) {
    ...
    temp_data.degree[HAL_TEMP_CH_0] += FEATURE_TEMPERATURE_DEGREE_OFFSET;
    temp_data.degree[HAL_TEMP_CH_1] += FEATURE_TEMPERATURE_DEGREE_OFFSET;
    temp_data.degree[HAL_TEMP_CH_2] += FEATURE_TEMPERATURE_DEGREE_OFFSET;
#endif
