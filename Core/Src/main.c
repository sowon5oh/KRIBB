...
static void MX_GPIO_Init(void) {
    ...
    CH1_LED_CON_Pin | CH2_LED_CON_Pin | CH3_LED_CON_Pin | ADC_RST__Pin, GPIO_PIN_RESET);
    ...
    OP_LED_Pin | EEPROM_WP_Pin | HEAT_CON3_Pin | HEAT_CON2_Pin | HEAT_CON1_Pin, GPIO_PIN_RESET);
