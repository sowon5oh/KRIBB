...
#define MMI_CMD3_MEAS_SET_VAL_REQ_DATA_LEN  (27)
...
#define MMI_CMD3_MEAS_SET_STABLE_TEMPERATURE_DEGREE_SCALE    100
...
#define MMI_CMD2_MEAS_REQ_TEMP_ADC_W_RESP       0x01
#define MMI_CMD3_MEAS_REQ_TEMP_ADC_CH1   		0x01
#define MMI_CMD3_MEAS_REQ_TEMP_ADC_CH2   		0x02
#define MMI_CMD3_MEAS_REQ_TEMP_ADC_CH3   		0x03
#define MMI_CMD3_MEAS_REQ_TEMP_ADC_ALL          0x04
...
#define MMI_CMD3_MEAS_REQ_X_DATA_LEN (2)
...
typedef struct {
    union {
        ...
        uint8_t msg[MMI_CMD3_MEAS_SET_VAL_REQ_DATA_LEN];
    };
} MeasSetDataMsg_t;
...
#define FRAM_TEMP_SETTING_DATA_LEN               (MMI_CMD3_MEAS_SET_TEMP_ONOFF_DATA_LEN * 3) //3

#define FRAM_LED_ON_TIME_ADDR                    (FRAM_TEMP_SETTING_ADDR + FRAM_TEMP_SETTING_DATA_LEN) //0x03
#define FRAM_LED_ON_TIME_SINGLE_DATA_LEN         MMI_CMD3_MEAS_SET_LED_ON_TIME_DATA_LEN //2
#define FRAM_LED_ON_TIME_DATA_LEN                (MMI_CMD3_MEAS_SET_LED_ON_TIME_DATA_LEN * 3) //6

#define FRAM_LED_ON_LEVEL_ADDR                   (FRAM_LED_ON_TIME_ADDR + FRAM_LED_ON_TIME_DATA_LEN) //0x09
#define FRAM_LED_ON_LEVEL_SINGLE_DATA_LEN        MMI_CMD3_MEAS_SET_LED_LEVEL_DATA_LEN //2
#define FRAM_LED_ON_LEVEL_DATA_LEN               (MMI_CMD3_MEAS_SET_LED_LEVEL_DATA_LEN * 3) //6

#define FRAM_ADC_SAMPLE_CNT_ADDR                 (FRAM_LED_ON_LEVEL_ADDR + FRAM_LED_ON_LEVEL_DATA_LEN) //0x0F
#define FRAM_ADC_SAMPLE_CNT_SINGLE_DATA_LEN      MMI_CMD3_MEAS_SET_ADC_SAMPLE_CNT_DATA_LEN //2
#define FRAM_ADC_SAMPLE_CNT_DATA_LEN             (FRAM_ADC_SAMPLE_CNT_SINGLE_DATA_LEN * 3) //6

#define FRAM_ADC_DELAY_MS_ADDR                   (FRAM_ADC_SAMPLE_CNT_ADDR + FRAM_ADC_SAMPLE_CNT_DATA_LEN) //0x15
#define FRAM_ADC_DELAY_MS_SINGLE_DATA_LEN        MMI_CMD3_MEAS_SET_ADC_DELAY_DATA_LEN //2
#define FRAM_ADC_DELAY_MS_DATA_LEN               (FRAM_ADC_DELAY_MS_SINGLE_DATA_LEN * 3) //6

#define FRAM_STABLE_TEMPERATURE_ADDR             (FRAM_ADC_DELAY_MS_ADDR + FRAM_ADC_DELAY_MS_DATA_LEN) //0x1B
...
#define FRAM_TEMP_RESULT_ADDR                    (FRAM_STABLE_TEMPERATURE_ADDR + FRAM_STABLE_TEMPERATURE_DATA_LEN) //0x1C
#define FRAM_TEMP_RESULT_SINGLE_DATA_LEN         MMI_CMD3_MEAS_REQ_X_DATA_LEN //2
#define FRAM_TEMP_RESULT_DATA_LEN                (FRAM_TEMP_RESULT_SINGLE_DATA_LEN * 3) //6

#define FRAM_RECV_PD_RESULT_ADDR                 (FRAM_TEMP_RESULT_ADDR + FRAM_TEMP_RESULT_DATA_LEN) //0x22
#define FRAM_RECV_PD_RESULT_SINGLE_DATA_LEN      MMI_CMD3_MEAS_REQ_X_DATA_LEN //2
#define FRAM_RECV_PD_RESULT_DATA_LEN             (FRAM_RECV_PD_RESULT_SINGLE_DATA_LEN * 3) //6

#define FRAM_MONITOR_PD_RESULT_ADDR              (FRAM_RECV_PD_RESULT_ADDR + FRAM_RECV_PD_RESULT_DATA_LEN) //0x28
#define FRAM_MONITOR_PD_RESULT_SINGLE_DATA_LEN   MMI_CMD3_MEAS_REQ_X_DATA_LEN //2
#define FRAM_MONITOR_PD_RESULT_DATA_LEN          (FRAM_MONITOR_PD_RESULT_SINGLE_DATA_LEN * 3) //6

#define FRAM_DEV_CTRL_LED_STATUS_ADDR            (FRAM_MONITOR_PD_RESULT_ADDR + FRAM_MONITOR_PD_RESULT_DATA_LEN) //0x2E
#define FRAM_DEV_CTRL_LED_STATUS_SINGLE_DATA_LEN MMI_CMD3_CTRL_DEVICE_LED_DATA_LEN //1
#define FRAM_DEV_CTRL_LED_STATUS_DATA_LEN        FRAM_DEV_CTRL_LED_STATUS_SINGLE_DATA_LEN

/* FRAM Write/Read Max Len */
#define FRAM_DATA_MIN_ADDR                FRAM_TEMP_SETTING_ADDR
#define FRAM_DATA_MAX_ADDR                FRAM_DEV_CTRL_LED_STATUS_ADDR
